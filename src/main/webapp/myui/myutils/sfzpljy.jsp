	...
	<script>
        ...
        var idCardNoUtil = {
            ...
            check15IdCardNo : function(idCardNo) {
                ...
                var check = /^[1-9][0-9]{7}((0[1-9])|(1[0-2]))((0[1-9])|([1-2][0-9])|(3[0-1]))[0-9]{3}$/
                        .test(idCardNo);
                if (!check)
                    return false;
                //校验地址码
            ...
            getIdCardInfo : function(idCardNo) {
                ...
                if (idCardNo.length == 15) {
                    ...
                    idCardInfo.province = idCardNoUtil.provinceAndCitys[parseInt(idCardNo
                            .substring(0, 2))];
