...
<a href="sjdx/plcl.do?id={{= sjdx.id}}&map['cllx']=ml&map['ids']={{= row[sjdx.zjzd]}}" a-oper="dxcl" qrts='false' title="目录"><i class="icon ion-ios-folder"></i></a>
<span class="divider"></span>
<a href="sjdx/getFile.do?id={{= sjdx.id}}&map['cllx']=zht&map['ids']={{= row[sjdx.zjzd]}}" a-oper="other" title="【{{= row.description}}】转换图"><i class="icon ion-network"></i></a>
</span>
</script>
<script>
function sjdxZdy(vp){
