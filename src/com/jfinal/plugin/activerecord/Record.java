...
public class Record implements Serializable {
	...
	public Integer getInt(String column) {
		return TypeUtils.castToInt(getColumns().get(column));
	}
	...
	public Long getLong(String column) {
		return TypeUtils.castToLong(getColumns().get(column));
	}
	...
	public java.math.BigInteger getBigInteger(String column) {
		return TypeUtils.castToBigInteger(getColumns().get(column));
	}
	...
	public java.util.Date getDate(String column) {
		return TypeUtils.castToDate(getColumns().get(column));
	}
	...
	public Double getDouble(String column) {
		return TypeUtils.castToDouble(getColumns().get(column));
	}
	...
	public Float getFloat(String column) {
		return TypeUtils.castToFloat(getColumns().get(column));
	}
	...
	public Boolean getBoolean(String column) {
		return TypeUtils.castToBoolean(getColumns().get(column));
	}
	...
	public java.math.BigDecimal getBigDecimal(String column) {
		return TypeUtils.castToBigDecimal(getColumns().get(column));
	}
