...
public class MetlMOIntercept extends MetaObjectIntercept {
	...
	*/
	...
	public String addBefore(AopContext ac) throws Exception {
		...
		record.set("create_date", Dict.getDbCurrentDateLL());
	...
	*/
	...
	public String updateBefore(AopContext ac) throws Exception {
		Record record = ac.record;
		record.set("update_date", Dict.getDbCurrentDateLL());
	...
	*/
	public void setOnameSpell(Record record, String oname) {
		if(StringUtil.isNotEmpty(oname)){
			record.set("simple_spell", Dict.getSimpleSpell(oname));
			record.set("full_spell", Dict.getFullSpell(oname));
		}else{
