...
(function($) {
    ...
    function _b(_c) {
        ...
        var _d = $("<span class=\"combo\">" + "<input type=\"text\" class=\"combo-text\" autocomplete=\"off\">" + "<span><span class=\"eova-icon-text\"></span></span>" + "<input type=\"hidden\" class=\"combo-value\">" + "</span>").insertAfter(_c);
    ...
    function _11(_12) {
        ...
        var _15 = _13.combo;
        if (_14.hasDownArrow) {
            _15.find(".eova-icon-text").show();
        } else {
            _15.find(".eova-icon-text").hide();
        }
	...
	function bindEvents(jq) {
		$('.eova-icon-text').click(function() {
			$(this).parents().siblings('input[type="text"]').val('');
		});
	};
    function _28(_29) {
    ...
    $.fn.combo = function(_63, _64) {
        ...
        return this.each(function() {
            ...
            if (_67) {
                ...
                _67 = $.data(this, "combo", {
                    options: $.extend({},
                    $.fn.combo.defaults, $.fn.combo.parseOptions(this), _63),
                    combo: r.combo,
                    panel: r.panel,
                    previousValue: null
                });
    ...
    $.fn.combo.parseOptions = function(_6f) {
        var t = $(_6f);
        return $.extend({},
        $.fn.validatebox.parseOptions(_6f), $.parser.parseOptions(_6f, ["width", "height", "separator", "panelAlign", {
            panelWidth: "number",
            editable: "boolean",
