            ...
            "qxpz": {
              ...
              "plclLeft": {
                ...
                "scst": {
                  ...
                  "content": "编辑模式",
                  "buttonOptions": {
                    "clfs": "处理方式：tcck：弹出窗口，download：文件下载，upload：文件上传，htqq：后台请求，ymcsth：页面参数替换，plbc：批量保存，默认htqq",
                    //弹窗扩展
                    "tckz": {
                      "width": "弹窗宽度",
                      "height": "弹窗高度"
                    ...
                    "sfxyxzjl": true,
                    //是否刷新页面，默认true,一般在列表页面使用
                    "sfsxym": true,
                    //请求结果合并到表单，默认false，就是通过后台请求来设置页面字段值，一般在表单页面使用
                    "jghbdbd": false,
                    "dcwjm": "导出文件名称，默认为数据对象名称的EXCEL文件",
                    //是否显示，默认显示
                    "isshow": true,
                    //是否关闭弹窗，默认false，在弹窗页面使用
                    "sfgbtc": false,
                    ...
                    //后台请求参数扩展，可以把当前页面参数取出来设置到请求参数中，在params之前合并
                    "htqqcskz": {
                      //<设置到基础信息中的key，从myData中取的只路径>
                      "obj": "dxjcxx.sjdx",
                      "fields.sjdx.cxmrz": "dxjcxx.sjdx.id"
